...
import illustration from '../../assets/antar_jemput.png';
import './Delivery.css'; // Reusing Delivery styles as the layout is identical
  ...
  return (
    <div className="delivery-landing-page animate-fade-in">
      ...
      <div className="delivery-landing-header">
        ...
        <img src={illustration} alt="Transport Illustration" className="delivery-illustration" />
        
        {/* Search Card overlapping illustration */}
        <div className="landing-search-card">
          <div className="landing-input-group" onClick={() => navigate('/customer/transport/location')}>
            <ArrowUp size={20} className="input-icon-up" />
            <div className="landing-input-placeholder">Cari lokasi penjemputan</div>
          </div>
          <div className="landing-divider"></div>
          <div className="landing-input-group" onClick={() => navigate('/customer/transport/location')}>
            <Target size={20} className="input-icon-target" />
            <div className="landing-input-placeholder">Cari lokasi pengantaran</div>
          </div>
        </div>
      </div>
      ...
      <main className="delivery-landing-content">
        ...
        <div 
          ...
          onClick={() => navigate('/customer/transport/map')} 
        >
