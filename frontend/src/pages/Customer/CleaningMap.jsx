...
// Default coordinate — defined OUTSIDE component to be stable. Array literals inside components
// are recreated every render, so [defaultPosition] in useEffect fires on every render.
...
export default function CleaningMap() {
  ...
  // and overwriting the user-selected address with the default location
  useEffect(() => {
