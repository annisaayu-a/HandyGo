...
import './ShoppingMap.css'; // Reusing map styling
      ...
      <div className="map-floating-header">
        ...
        <div className="location-input-group">
          ...
          <input 
            ...
            placeholder={step === 'pickup' ? "Ketik lokasi penjemputan di sini" : "Lokasi penjemputan (Tersimpan)"}
      ...
      <div className="bottom-sheet" style={{ zIndex: 1000 }}>
        <div className="bottom-sheet-header">
          <h2 className="sheet-title">
            {step === 'pickup' ? 'Set lokasi penjemputan' : 'Set lokasi pengantaran'}
          </h2>
