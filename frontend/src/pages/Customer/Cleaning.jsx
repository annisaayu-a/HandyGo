...
export default function Cleaning() {
  ...
  return (
    <div className="cleaning-page animate-fade-in">
      ...
      <div className="cleaning-landing-header">
        <button className="back-btn-overlay" onClick={() => navigate(-1)}>
          <ChevronLeft size={24} color="#1e293b" />
        </button>
        <div className="illustration-wrapper">
          <img src={illustration} alt="Cleaning Illustration" className="cleaning-illustration" onError={(e) => { e.target.style.display = 'none'; e.target.parentElement.style.backgroundColor = '#fce7d2'; }} />
        </div>
        
        {/* Location Inputs Card Overlapping Illustration */}
        <div className="location-card">
          <div className="location-input-group" onClick={() => navigate('/customer/search-location', { state: { returnUrl: '/customer/cleaning/checkout' } })}>
      ...
      <div className="cleaning-content">
        ...
        <div className="map-container" onClick={() => navigate('/customer/cleaning/map')}>
          <iframe 
